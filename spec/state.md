...
| Platform | Directory                                            |
| -------- | ---------------------------------------------------- |
| macOS    | `~/Library/Application Support/app.canmi.rdm/`       |
| Linux    | `$XDG_STATE_HOME/rdm/`, by default `~/.local/state/rdm/` |
| Windows  | `%LOCALAPPDATA%\canmi\rdm\`                          |
...
Two files, because two kinds of writing:
